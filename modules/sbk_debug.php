...
////////////
    ...
    function debugTakeAllDeck() {
        $playerId = 2343492;
        $this->DbQuery( "UPDATE tile SET location = 'hand', player_id = $playerId WHERE location = 'deck'" );
    }

    function debugTakeAllPharaoh() {
        $playerId = 2343492;
        $this->DbQuery( "UPDATE tile SET location = 'hand', player_id = $playerId WHERE deck = 'pharaoh'" );
    }
