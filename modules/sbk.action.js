function onClickBoard( event ) {
	...
	this.ajaxcall( "/sobektwoplayers/sobektwoplayers/selectMarketTile.html", { 
		lock: true,
...
function onClickPirogue( event ) {
	...
	this.ajaxcall( "/sobektwoplayers/sobektwoplayers/pickPirogue.html", { 
		lock: true,
...
function onClickExtra( event ) {
	...
	if ( dojo.hasClass(event.target, 'sprite-pirogue') ) {
		...
		// Laziness. New action?
		this.ajaxcall( "/sobektwoplayers/sobektwoplayers/answer.html", { 
			lock: true,
...
function onPlayCharacter() {
	...
	if (q.length == 1) {
		this.ajaxcall( "/sobektwoplayers/sobektwoplayers/playCharacter.html", { 
			lock: true,
...
function onSellSet() {
	...
	this.ajaxcall( "/sobektwoplayers/sobektwoplayers/sell.html", { 
		lock: true,
		tile_ids: tiles,
	}, this,
		function( result ) {},
...
function onRefillBoard() {
	...
	this.ajaxcall( "/sobektwoplayers/sobektwoplayers/refill.html", { 
		lock: true
	}, this,
		function( result ) {},
		function( is_error) {}
