 ...
 * -----
 * 
 * sobektwoplayers.action.php
 *
 * SobekTwoPlayers main action entry point
 *
 *
 ...
 * this.ajaxcall( "/sobektwoplayers/sobektwoplayers/myAction.html", ...)
 *
 */
  
  
  class action_sobektwoplayers extends APP_GameAction
  { 
    // Constructor: please do not modify
   	public function __default()
  	{
  	    ...
  	    {
            $this->view = "sobektwoplayers_sobektwoplayers";
